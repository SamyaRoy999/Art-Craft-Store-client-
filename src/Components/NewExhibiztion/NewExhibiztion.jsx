...
const NewExhibiztion = () => {
    return (
        <div className=" mx-auto container gap-5 flex-wrap flex flex-1 items-center justify-between">
            <div className="grid grid-cols-3 gap-4">
                <div className=" ">
                    <img className=" w-40 h-72" src="https://i.ibb.co/mCdJQgC/india-republic-day-celebration-digital-art-with-woman-portrait.jpg" alt="" />
                </div>
                <div className=" ">
                    <img className=" w-40 h-72" src="https://i.ibb.co/syQW7sS/2151123847.jpg" alt="" />
                </div>
                <div className=" ">
                    <img className=" w-40 h-72" src="https://i.ibb.co/0FkNX5x/2151135152.jpg" alt="" />
                </div>
                <div className=" ">
                    <img className=" w-40 h-72" src="https://i.ibb.co/6WypDZ8/2151151089.jpg" alt="" />
                </div>
                <div className=" ">
                    <img className=" w-40 h-72" src="https://i.ibb.co/z890xJg/32099.jpg" alt="" />
                </div>
                <div className=" ">
            ...
            <div className="  text-right flex-1">
                <h3 className="text-5xl text-[#E65B56] mb-6 font-normal font-EB_Garamond ">Artisanal Treasures: <br /> Handcrafted Delights Await</h3>
                <p className=' font-normal mb-5'> Explore a world of artisanal craftsmanship with our curated selection of handcrafted treasures. From intricately carved wooden sculptures to meticulously woven textiles, each piece tells a story of tradition, skill, and creativity.</p>
